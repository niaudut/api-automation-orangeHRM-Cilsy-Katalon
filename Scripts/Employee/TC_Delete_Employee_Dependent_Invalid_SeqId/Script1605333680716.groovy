...
def seqId = result1.data[0].sequenceNumber
...
WS.sendRequestAndVerify(findTestObject('Employee/DELETE_Employee_Dependent_Wrong_SeqId', [('url') : GlobalVariable.url, ('token') : GlobalVariable.token]))
